...
import { fetchHubs, fetchHubsGrouped, toggleHubStatus } from '../../features/superadmin/hubs/api';
import AddEditHubModal from '../../features/superadmin/hubs/components/add-edit-hub-modal';
import HubCard from '../../features/superadmin/hubs/components/hub-card';
import { GroupedHubs, HubFilter, HubStatus, HubSummary } from '../../features/superadmin/hubs/types';

export default function HubListScreenRN() {
  ...
  const handleViewInventory = (hub: HubSummary) => {
    // Navigate to inventory screen for this hub
    console.log('📦 Navigating to inventory for hub:', hub.name, 'ID:', hub.id);
    try {
      // Use the navigation prop to navigate to the inventory screen
  ...
  const toggleViewMode = () => {
    ...
    // loadHubs() will be triggered by the useEffect when viewMode changes
  };
